...
if __name__ == "__main__":
    ...
    csv_file = './coordinates/coordinates_georeferenced.csv'  # Replace with your CSV file path
    ...
    output_file = './coordinates/coordinates_rotated.csv'  # Replace with desired output file path
